...
from ravendb.legacy.commands.raven_commands import (
...
from ravendb.legacy.subscriptions.data import SubscriptionCreationOptions, SubscriptionWorkerOptions
from ravendb.legacy.subscriptions.subscription import SubscriptionWorker
