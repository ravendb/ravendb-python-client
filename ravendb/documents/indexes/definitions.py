...
class IndexDefinitionCompareDifferences(IntFlag):
    ...
    ALL = (
        MAPS | REDUCE | FIELDS | CONFIGURATION | LOCK_MODE | PRIORITY | STATE
        | ADDITIONAL_SOURCES | ADDITIONAL_ASSEMBLIES | DEPLOYMENT_MODE | COMPOUND_FIELDS
        | ARCHIVED_DATA_PROCESSING_BEHAVIOR | SCHEMA_VALIDATION_CONFIGURATION
    )
