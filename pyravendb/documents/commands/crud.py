...
from pyravendb.documents.commands.results import GetDocumentsResult
...
from pyravendb.http.raven_command import VoidRavenCommand
from pyravendb.documents.identity.hilo import HiLoResult
