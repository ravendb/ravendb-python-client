...
from pyravendb.documents.queries.index_query import IndexQuery, Parameters
from pyravendb.documents.queries.misc import SearchOperator
from pyravendb.documents.queries.more_like_this import (
    MoreLikeThisScope,
    MoreLikeThisBase,
    MoreLikeThisBuilder,
...
from pyravendb.documents.queries.query import QueryOperator, QueryResult, QueryTimings, ProjectionBehavior, QueryData
from pyravendb.documents.queries.spatial import DynamicSpatialField, SpatialCriteria, SpatialCriteriaFactory
from pyravendb.documents.queries.suggestions import (
    SuggestionBase,
    SuggestionWithTerm,
    SuggestionOptions,
    SuggestionWithTerms,
...
if TYPE_CHECKING:
    from pyravendb.documents.store.document_store import Lazy
