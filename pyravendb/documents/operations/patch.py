...
from pyravendb.documents.operations.definitions import OperationIdResult, IOperation, _Operation_T
from pyravendb.documents.operations.misc import QueryOperationOptions
