...
from pyravendb.documents.session.operations.lazy import LazySuggestionQueryOperation
from pyravendb.documents.session.operations.query import QueryOperation
from pyravendb.tools.utils import Stopwatch

_T = TypeVar("_T")

if TYPE_CHECKING:
    from pyravendb.documents.store import Lazy
    from pyravendb.documents.session.query import DocumentQuery
