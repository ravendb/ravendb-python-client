...
class GetTimeSeriesOperation(Operation):
    ...
    def get_command(self, store, conventions, cache=None):
        return self._GetTimeSeriesCommandOld(self._document_id, self._ranges, self._start, self._page_size)

    class _GetTimeSeriesCommandOld(OldRavenCommand):
        def __init__(
            self,
            document_id: str,
...
class TimeSeriesBatchOperation(Operation):
    ...
    def get_command(self, store, conventions, cache=None):
        return self._TimeSeriesBatchCommandOld(self._document_id, self._operation)

    class _TimeSeriesBatchCommandOld(OldRavenCommand):
        def __init__(self, document_id: str, operation: TimeSeriesOperation):
