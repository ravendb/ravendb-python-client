...
class GetCountersOperation(Operation):
    ...
    def get_command(self, store, conventions, cache=None):
        return self._GetCounterValuesCommandOld(self._document_id, self._counters, self._return_full_result)

    class _GetCounterValuesCommandOld(OldRavenCommand):
        def __init__(
            self,
            document_id: str,
            counters: List[str],
...
class CounterBatchOperation(Operation):
    ...
    def get_command(self, store, conventions, cache=None):
        return self._CounterBatchCommandOld(self._counter_batch)

    class _CounterBatchCommandOld(OldRavenCommand):
